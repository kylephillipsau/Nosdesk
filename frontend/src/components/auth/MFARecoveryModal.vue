      ...
      >
        ...
        >
          ...
          <div class="px-6 py-4 bg-slate-700/30 border-b border-slate-700/50 flex items-center justify-between">
            <h2 class="text-lg font-semibold text-white">MFA Account Recovery</h2>
            <button
              @click="close"
          ...
          <div class="p-6">
            ...
            <div v-if="emailSent" class="flex flex-col items-center gap-4 text-center">
              ...
              <div class="bg-amber-600/10 border border-amber-600/20 rounded-lg p-4 text-sm text-slate-300">
            ...
            <form v-else @submit.prevent="handleSubmit" class="flex flex-col gap-4">
              ...
              <!-- Email Input -->
              <div>
                <label for="mfa-recovery-email" class="block text-sm font-medium text-slate-300 mb-2">
                  Email Address
                </label>
                <input
              ...
              <!-- Password Input -->
              <div>
                <label for="mfa-recovery-password" class="block text-sm font-medium text-slate-300 mb-2">
                  Password
                </label>
                <input
              ...
              <!-- Security Notice -->
              <div class="bg-blue-600/10 border border-blue-600/20 rounded-lg p-3 text-xs text-slate-300">
