  ...
  <div class="bg-slate-800 rounded-lg p-6 w-full">
    ...
    <div class="flex justify-between items-center mb-4">
      <h3 class="text-slate-400 text-sm font-medium">
        {{ props.ticketStatus === 'closed' ? 'Closed Tickets' : 'Ticket Activity' }} Heatmap
      </h3>
      <button 
    ...
    <!-- Loading State -->
    <div v-else-if="isLoading" class="flex justify-center items-center h-32 text-slate-400">
    ...
    <div v-else class="w-full">
      ...
      <div class="flex flex-col gap-2 w-full">
        ...
        <div class="flex gap-1.5 w-full">
          <!-- Days of week labels -->
          <div class="flex flex-col gap-0.5 text-[10px] text-slate-400/80 justify-around flex-shrink-0">
          ...
          <div class="flex-1 min-w-0">
            <div class="grid gap-0.5 w-full" 
              ...
              >
                ...
                >
                  <div
                    class="w-full h-2.5 max-h-3 rounded-[1px] transition-all duration-200 hover:scale-110 hover:z-10 border border-slate-700/50"
                    :class="{
                      'cursor-pointer hover:border-slate-600': day.count > 0,
